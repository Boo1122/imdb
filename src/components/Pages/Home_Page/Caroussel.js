...
export class Caroussel {
  ...
  carousselSkeleton() {
    ...
    img1.setAttribute("src", "./public/avatar_photos/avatar1.png");
    ...
    img2.setAttribute("src", "./public/avatar_photos/avatar2.png");
    ...
    innerDiv3.style.backgroundImage = "url('./public/reviewBkgr/film.jpg')";
    ...
    img3.setAttribute("src", "./public/avatar_photos/avatar3.png");
    ...
    innerDiv4.style.backgroundImage = "url('./public/reviewBkgr/film.jpg')";
    ...
    img4.setAttribute("src", "./public/avatar_photos/avatar4.png");
    ...
    innerDiv5.style.backgroundImage = "url('./public/reviewBkgr/film.jpg')";
    ...
    img5.setAttribute("src", "./public/avatar_photos/avatar5.png");
    ...
    innerDiv6.style.backgroundImage = "url('./public/reviewBkgr/film.jpg')";
    ...
    img6.setAttribute("src", "./public/avatar_photos/avatar6.png");
    ...
    innerDiv7.style.backgroundImage = "url('./public/reviewBkgr/film.jpg')";
    ...
    img7.setAttribute("src", "./public/avatar_photos/avatar7.png");
    ...
    carousselToHomepage.appendChild(carousselWrap);
